...
(function ( window, undefined ) {
    ...
    var jQuery = (function () {
        ...
        jQuery.each(
            "Boolean Number String Function Array Date RegExp Object".split(" "), function (i, name) {
    ...
    */
    ...
    if (!jQuery.support.hrefNormalized ) {
        jQuery.each(
            [ "href", "src", "width", "height" ], function ( i, name ) {
                jQuery.attrHooks[ name ] = jQuery.extend(
                    jQuery.attrHooks[ name ], {
                        get: function ( elem ) {
    ...
    */
    ...
    jQuery.fn.css = function ( name, value ) {
        ...
        return jQuery.access(
            this, name, value, true, function ( elem, name, value ) {
    ...
    */
    ...
    function genFx( type, num ) 
    {
        ...
        jQuery.each(
            fxAttrs.concat.apply([], fxAttrs.slice(0, num)), function () {
                obj[ this ] = type;
            }
        );
