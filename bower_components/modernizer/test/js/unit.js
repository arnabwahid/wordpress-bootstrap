...
test(
    "document.documentElement is valid and correct",1, function () {
...
test(
    "no-js class is gone.", function () {

        ok(
            !/(?:^|\s)no-js(?:^|\s)/.test(document.documentElement.className),
            'no-js class is gone'
        );

        ok(
            /(?:^|\s)js(?:^|\s)/.test(document.documentElement.className),
        ...
        ok(
            /(?:^|\s)i-has-no-js(?:\s|$)/.test(document.documentElement.className),
            'html.i-has-no-js class is still present'
        );

        if (document.querySelector) {
            ok(
                document.querySelector('html.js') == document.documentElement,
...
test(
    'html classes are looking good',function () {
        ...
        $.each(
            TEST.deprecated, function (key, val) {
        ...
        $.each(
            ['\\+no-js', 'no-js-', 'i-has-no-js'], function (i, fakeClass) {
...
test(
    'Modernizr properties are looking good',function () {
        ...
        for (var prop in window.Modernizr){
            if (Modernizr.hasOwnProperty(prop)) {
                ...
                ok(
                    Modernizr[prop] === true || Modernizr[prop] === false,
...
test(
    'Modernizr.audio and Modernizr.video',function () {
...
test(
    'Modernizr results match expected values',function () {
...
test(
    'Modernizr.addTest()',22,function () {
        ...
        ok(
            docEl.className.indexOf(' testcamelCase') === -1,
...
test(
    'Modernizr.mq: media query testing',function () {
...
test(
    'Modernizr._[properties]',function () {
...
test(
    'Modernizr.testProp()',function () {
        ...
        equal(
            'pointerEvents' in  document.createElement('div').style,
...
test(
    'Modernizr.testAllProps()',function () {
...
test(
    'Modernizr.prefixed() - css and DOM resolving', function () {
...
test(
    'Modernizr.prefixed autobind', function () {
